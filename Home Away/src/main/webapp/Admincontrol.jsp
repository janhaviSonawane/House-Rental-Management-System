...
<body>
    ...
    <header>
        <div class="nav contailer">
            ...
            <!-- LogIn -->
            <a href="Login.jsp" class="btn">Log Out</a>
        </div>
    </header>
    ...
    <section class="properties container"  id="properties">
        ...
        <div style="margin-top:30px;" class="properties-container container">
	...
	<!-- Info -->
	 <section class="about container" id="about">
        <div class="about-img">
            <img src="ainfo.jpg" alt="">
        </div>
        <div class="about-text">
            <p>Admin Operations</p>
            <a href="Reports.jsp" class="btn">Reports Generation</a><br><br>
            <a href="Properties.jsp" class="btn">Properties</a><br><br>
            <a href="HOwner.jsp" class="btn">House Owners</a><br><br>
            <a href="Verify.jsp" class="btn">Verifications</a><br><br>
            <a href="VisitPlanned.jsp" class="btn">Visit</a><br>
        </div>
    </section>
    <!-- Footer -->
